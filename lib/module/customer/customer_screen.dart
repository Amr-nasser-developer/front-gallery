...
class CustomerScreen extends StatelessWidget {
      ...
      builder: (context, state){
          return Scaffold(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Row(
                              ...
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Expanded(child: Text('Id',style: TextStyle(color: Colors.black,fontSize: 24.0),)),
                                Expanded(child: Text('Arabic Name',style: TextStyle(color: Colors.black,fontSize: 24.0),)),
                                Expanded(child: Text('English Name',style: TextStyle(color: Colors.black,fontSize: 24.0),)),
                                Expanded(child: Text('Phone',style: TextStyle(color: Colors.black,fontSize: 24.0),)),
                                Expanded(child: Text('        ',style: TextStyle(color: Colors.black,fontSize: 24.0),)),
                          ...
                          Expanded(
                            child: ListView.separated(
                                shrinkWrap: true,
                                itemBuilder: (context,index)=>customerTable(GalleryCubit.get(context).customer[index], context) ,
                                separatorBuilder: (context,index)=> Divider(height: 2,),
                                itemCount: GalleryCubit.get(context).customer.length
                            ),
                          ),
                        ],
                      ),
            ...
            floatingActionButton: FloatingActionButton(
              ...
              child: Icon(
                GalleryCubit.get(context).fabIcon
              ),
            ),
          );
      },
  ...
  Widget customerTable(model,context)=>
      Column(
            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(child: IconButton(onPressed: (){
                  GalleryCubit.get(context).deleteCustomer(
                    id: model['id']
                  );
